...
int main() {
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. Delhi\n");
    }
    ...
    if (answer == 1) {
        ...
        printf("Incorrect! Correct answer: 1. Dennis Ritchie\n");
    }
    ...
    if (answer == 1) {
        ...
        printf("Incorrect! Correct answer: 1. 81\n");
    }
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. Mars\n");
    }
    ...
    if (answer == 1) {
        ...
        printf("Incorrect! Correct answer: 1. 100°C\n");
    }
    ...
    if (answer == 3) {
        ...
        printf("Incorrect! Correct answer: 3. char\n");
    }
    ...
    if (answer == 3) {
        ...
        printf("Incorrect! Correct answer: 3. 7\n");
    }
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. 12\n");
    }
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. William Shakespeare\n");
    }
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. Carbon Dioxide\n");
    }
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. Blue Whale\n");
    }
    ...
    if (answer == 2) {
        ...
        printf("Incorrect! Correct answer: 2. APJ Abdul Kalam\n");
    }

    // Question 13
    printf("\nQ13. What is the value of pi approximately?\n");
    printf("1. 3.14\n2. 2.17\n3. 1.62\n4. 4.13\n");
    printf("Enter your answer: ");
    scanf("%d", &answer);
    if (answer == 1) {
        ...
        printf("Incorrect! Correct answer: 1. 3.14\n");
    }
    ...
    if (answer == 1) {
        ...
        printf("Incorrect! Correct answer: 1. Nile\n");
    }
    ...
    if (answer == 3) {
        ...
        printf("Incorrect! Correct answer: 3. 1947\n");
    }
